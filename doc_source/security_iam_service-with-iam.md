# How AWS Global Accelerator works with IAM<a name="security_iam_service-with-iam"></a>
...
## Identity\-based policies for Global Accelerator<a name="security_iam_service-with-iam-id-based-policies"></a>
...
## Resource\-based policies within Global Accelerator<a name="security_iam_service-with-iam-resource-based-policies"></a>
...
## Policy actions for Global Accelerator<a name="security_iam_service-with-iam-id-based-policies-actions"></a>
...
## Policy resources for Global Accelerator<a name="security_iam_service-with-iam-id-based-policies-resources"></a>
...
## Policy condition keys for Global Accelerator<a name="security_iam_service-with-iam-id-based-policies-conditionkeys"></a>
...
## ACLs in Global Accelerator<a name="security_iam_service-with-iam-acls"></a>
...
## ABAC with Global Accelerator<a name="security_iam_service-with-iam-tags"></a>
...
## Using temporary credentials with Global Accelerator<a name="security_iam_service-with-iam-roles-tempcreds"></a>
...
## Cross\-service principal permissions for Global Accelerator<a name="security_iam_service-with-iam-principal-permissions"></a>
...
## Service roles for Global Accelerator<a name="security_iam_service-with-iam-roles-service"></a>
...
## Service\-linked role for Global Accelerator<a name="security_iam_service-with-iam-roles-service-linked"></a>
...
For more information about the service\-linked role for Global Accelerator, see [Service\-linked role for Global Accelerator](using-service-linked-roles.md)\.
